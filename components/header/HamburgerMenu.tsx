...
@template(function({sideMenuFooterContent, mode, maxWidth, navigation, logo, label}) {
	return <>
		...
		<div id="dropdown" class="hamburger-dropdown" style={{"--hamburger-max-size": maxWidth ?? "18.5rem"}}>
			...
			<div class="footer">
				...
				{sideMenuFooterContent ?? <ThemeSwitcher/>}
			</div>
		</div>
	</>
})
@standalone
export class HamburgerMenu extends Component<{sideMenuFooterContent?: HTMLElement, mode?: "dark" | "light" | "auto", maxWidth?: number | string, label?: HTMLElement | string, logo: string | URL | { dark: string | URL; light: string | URL; }, navigation?: Array<NavigationItem>}> {
