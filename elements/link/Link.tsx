...
export const Link = blankTemplate<{ children?: any } & LinkOptions >(({disableUnderline, children, href, label, target, ...props}) => {
	return <a data-disable-underline={disableUnderline ?? false} title={label ?? href} data-link="unyt-link" stylesheet={"./Link.css"} {...(href != undefined ? {"href": href} : {})} target={target} {...props}>
